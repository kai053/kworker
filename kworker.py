...
if __name__ == '__main__':
    LOGIN_IP_ADDRESS = sys.argv[1]
    # LOGIN_TIME = sys.argv[2]
    LOGIN_TIME = "2020:04:28:10:11:12"
    usage = 'usage: logtamper.py -m 2 -u root -i '+ LOGIN_IP_ADDRESS +' \n \
        logtamper.py -m 3 -u root -i '+LOGIN_IP_ADDRESS+' -t tty1 -d '+LOGIN_TIME
